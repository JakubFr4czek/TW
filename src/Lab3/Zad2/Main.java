...
class Statystyki extends Thread{
    ...
    public void run(){
        ...
        while(true){
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter("zad2.txt"))) {
...
public class Main {
    public void main(String[] args) {
        ...
        List<Lab3.Zad2.Filozof> filozofowie = new ArrayList<Lab3.Zad2.Filozof>();
        ...
        for(int i = 0; i < n; i += 1){
            ...
            Lab3.Zad2.Filozof nowy_filozof;

            if(i + 1 < n){
                nowy_filozof = new Lab3.Zad2.Filozof(widelce.get(i), widelce.get(i+1), i);
            }else{
                nowy_filozof = new Lab3.Zad2.Filozof(widelce.get(i), widelce.get(0), i);
            }
